...
let filteredCities = cities.filter((city) => city.endsWith('i'));
...
let theTotal = foods.filter(food => food.tags.includes('rice')).reduce((a, c) => a.price === undefined ? a + c.price : a.price + c.price)
